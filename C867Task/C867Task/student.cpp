...
{
	string value1 = to_string(days_per_course[0]);
	string value2 = to_string(days_per_course[1]);
	string value3 = to_string(days_per_course[2]);
...
void student::set_age(string age)
{
	this->age = age;
}
